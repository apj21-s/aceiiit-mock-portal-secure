(function () {
  ...
  window.AceIIIT.db = {
    ...
    getAppConfig: bind("getAppConfig"),
    listReminders: bind("listReminders"),
    ...
    updateAppConfig: bind("updateAppConfig"),
    createReminder: bind("createReminder"),
    updateReminder: bind("updateReminder"),
    deleteReminder: bind("deleteReminder"),
